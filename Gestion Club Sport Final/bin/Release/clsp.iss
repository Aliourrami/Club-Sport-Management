...
AppId={{58689242-3B15-4A50-AE74-C55ECABB470B}
AppName=gestion club sport
AppVersion=1.5
;AppVerName=gestion club sport 1.5
AppPublisher=My Company, Inc.
AppPublisherURL=http://www.example.com/
AppSupportURL=http://www.example.com/
AppUpdatesURL=http://www.example.com/
DefaultDirName={pf}\gestion club sport
...
[Icons]
Name: "{commonprograms}\gestion club sport"; Filename: "{app}\Gestion Club Sport Final.exe"
Name: "{commondesktop}\gestion club sport"; Filename: "{app}\Gestion Club Sport Final.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\Gestion Club Sport Final.exe"; Description: "{cm:LaunchProgram,gestion club sport}"; Flags: nowait postinstall skipifsilent
